...
/**
 * MoIP integration class for AktiveMerchant 
 *
...
class Merchant_Billing_Example extends Merchant_Billing_Gateway {
  const TEST_URL = 'https://desenvolvedor.moip.com.br/sandbox/ws/alpha/EnviarInstrucao/Unica/';
  const LIVE_URL = 'https://www.moip.com.br/ws/alpha/EnviarInstrucao/Unica/';

  # The countries the gateway supports merchants from as 2 digit ISO country codes
  protected $supported_countries = array('BR');

  # The card types supported by the payment gateway
  protected $supported_cardtypes = array('visa', 'master', 'american_express', 'switch', 'solo', 'maestro');

  # The homepage URL of the gateway
  protected $homepage_url = 'http://www.moip.com.br';

  # The display name of the gateway
  protected $display_name = 'MoIP Pagamentos';
